  ...
  useEffect(() => {
    if (item) {
      ...
      for (const entry of entriesArr) {
        ...
        modifier.qty = quantity * item.qty;
  ...
  return (
    <>
      <div className="bg-white border-gray p-block container-fluid">
        <div className="row justify-content-md-center">
          ...
          <div className="col-4 d-flex">
            <div className="p-d-flex quantity-increase-decrease-container mr-auto">
              <Button
                className="btn right-border-radius left_quantity h-30 red-btn"
                variant="danger"
                onClick={() => {
              ...
              />
              <Button
                className="btn left-border-radius right_quantity h-30 red-btn"
                variant="danger"
                onClick={() => {
          ...
          <div className="col-3">
            <p className="medium_para font_semibold mt8 text-right">
              {Money.moneyFormat(
                Money.itemPriceWithQtyMinusModifers(item.price, item.qty)
              )}
        ...
        <p
          className="medium_para mb0 pb0 customize-label mt10"
